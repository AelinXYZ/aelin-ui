...
export type AcceptDealFilter = {
	...
	underlyingToHolderAmt?: WeiSource | null;
	underlyingToHolderAmt_not?: WeiSource | null;
	underlyingToHolderAmt_gt?: WeiSource | null;
	underlyingToHolderAmt_lt?: WeiSource | null;
	underlyingToHolderAmt_gte?: WeiSource | null;
	underlyingToHolderAmt_lte?: WeiSource | null;
	underlyingToHolderAmt_in?: WeiSource[];
	underlyingToHolderAmt_not_in?: WeiSource[];
};
...
export const useGetAcceptDealById = <K extends keyof AcceptDealResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: AcceptDealArgs<K>,
	queryOptions: UseQueryOptions<Pick<AcceptDealResult, K>> = {}
) => {
	const func = async function <K extends keyof AcceptDealResult>(
		url: string,
		options: SingleQueryOptions,
		args: AcceptDealArgs<K>
	): Promise<Pick<AcceptDealResult, K>> {
		...
		if (obj['underlyingToHolderAmt'])
			formattedObj['underlyingToHolderAmt'] = wei(obj['underlyingToHolderAmt'], 0);
		return formattedObj as Pick<AcceptDealResult, K>;
	};
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('AcceptDeal', options, args) : null],
...
export const useGetAcceptDeals = <K extends keyof AcceptDealResult>(
	url: string,
	options?: MultiQueryOptions<AcceptDealFilter, AcceptDealResult>,
	args?: AcceptDealArgs<K>,
	queryOptions: UseQueryOptions<Pick<AcceptDealResult, K>[]> = {}
) => {
	const func = async function <K extends keyof AcceptDealResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<AcceptDealFilter, AcceptDealResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof AcceptDealFilter;
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('AcceptDeals', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export type ClaimedUnderlyingDealTokensArgs<K extends keyof ClaimedUnderlyingDealTokensResult> = {
	[Property in keyof Pick<
		ClaimedUnderlyingDealTokensFields,
		K
	>]: ClaimedUnderlyingDealTokensFields[Property];
};
export const useGetClaimedUnderlyingDealTokensById = <
	K extends keyof ClaimedUnderlyingDealTokensResult
>(
	url: string,
	options?: SingleQueryOptions,
	args?: ClaimedUnderlyingDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<ClaimedUnderlyingDealTokensResult, K>> = {}
) => {
	const func = async function <K extends keyof ClaimedUnderlyingDealTokensResult>(
		url: string,
		options: SingleQueryOptions,
		args: ClaimedUnderlyingDealTokensArgs<K>
	): Promise<Pick<ClaimedUnderlyingDealTokensResult, K>> {
		const res = await axios.post(url, {
...
export const useGetClaimedUnderlyingDealTokenss = <
	K extends keyof ClaimedUnderlyingDealTokensResult
>(
	url: string,
	options?: MultiQueryOptions<ClaimedUnderlyingDealTokensFilter, ClaimedUnderlyingDealTokensResult>,
	args?: ClaimedUnderlyingDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<ClaimedUnderlyingDealTokensResult, K>[]> = {}
) => {
	const func = async function <K extends keyof ClaimedUnderlyingDealTokensResult>(
		...
		options: MultiQueryOptions<
			ClaimedUnderlyingDealTokensFilter,
			ClaimedUnderlyingDealTokensResult
		>,
		args: ClaimedUnderlyingDealTokensArgs<K>
	): Promise<Pick<ClaimedUnderlyingDealTokensResult, K>[]> {
		const paginatedOptions: Partial<
			MultiQueryOptions<ClaimedUnderlyingDealTokensFilter, ClaimedUnderlyingDealTokensResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof ClaimedUnderlyingDealTokensFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	return useQuery(
		[
			'codegen-graphql',
			enabled ? generateGql('ClaimedUnderlyingDealTokenss', options, args) : null,
		],
		async () => func(url, options!, args!),
		{
			...queryOptions,
...
export const useGetDealCreatedById = <K extends keyof DealCreatedResult>(
	url: string,
	options?: SingleQueryOptions,
	...
	const func = async function <K extends keyof DealCreatedResult>(
		...
		options: SingleQueryOptions,
		args: DealCreatedArgs<K>
	): Promise<Pick<DealCreatedResult, K>> {
		const res = await axios.post(url, {
...
export const useGetDealCreateds = <K extends keyof DealCreatedResult>(
	url: string,
	options?: MultiQueryOptions<DealCreatedFilter, DealCreatedResult>,
	args?: DealCreatedArgs<K>,
	queryOptions: UseQueryOptions<Pick<DealCreatedResult, K>[]> = {}
) => {
	const func = async function <K extends keyof DealCreatedResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<DealCreatedFilter, DealCreatedResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof DealCreatedFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DealCreateds', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetDealDetailsById = <K extends keyof DealDetailsResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: DealDetailsArgs<K>,
	queryOptions: UseQueryOptions<Pick<DealDetailsResult, K>> = {}
) => {
	const func = async function <K extends keyof DealDetailsResult>(
		url: string,
		options: SingleQueryOptions,
		args: DealDetailsArgs<K>
	): Promise<Pick<DealDetailsResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DealDetails', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetDealDetailss = <K extends keyof DealDetailsResult>(
	url: string,
	options?: MultiQueryOptions<DealDetailsFilter, DealDetailsResult>,
	args?: DealDetailsArgs<K>,
	queryOptions: UseQueryOptions<Pick<DealDetailsResult, K>[]> = {}
) => {
	const func = async function <K extends keyof DealDetailsResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<DealDetailsFilter, DealDetailsResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof DealDetailsFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DealDetailss', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetDealFullyFundedById = <K extends keyof DealFullyFundedResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: DealFullyFundedArgs<K>,
	queryOptions: UseQueryOptions<Pick<DealFullyFundedResult, K>> = {}
) => {
	const func = async function <K extends keyof DealFullyFundedResult>(
		url: string,
		options: SingleQueryOptions,
		args: DealFullyFundedArgs<K>
	): Promise<Pick<DealFullyFundedResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DealFullyFunded', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetDealFullyFundeds = <K extends keyof DealFullyFundedResult>(
	url: string,
	options?: MultiQueryOptions<DealFullyFundedFilter, DealFullyFundedResult>,
	args?: DealFullyFundedArgs<K>,
	queryOptions: UseQueryOptions<Pick<DealFullyFundedResult, K>[]> = {}
) => {
	const func = async function <K extends keyof DealFullyFundedResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<DealFullyFundedFilter, DealFullyFundedResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof DealFullyFundedFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DealFullyFundeds', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetDepositDealTokensById = <K extends keyof DepositDealTokensResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: DepositDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<DepositDealTokensResult, K>> = {}
) => {
	const func = async function <K extends keyof DepositDealTokensResult>(
		url: string,
		options: SingleQueryOptions,
		args: DepositDealTokensArgs<K>
	): Promise<Pick<DepositDealTokensResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DepositDealTokens', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetDepositDealTokenss = <K extends keyof DepositDealTokensResult>(
	url: string,
	options?: MultiQueryOptions<DepositDealTokensFilter, DepositDealTokensResult>,
	args?: DepositDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<DepositDealTokensResult, K>[]> = {}
) => {
	const func = async function <K extends keyof DepositDealTokensResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<DepositDealTokensFilter, DepositDealTokensResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof DepositDealTokensFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DepositDealTokenss', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export type MintDealTokensFilter = {
	id?: string | null;
	id_not?: string | null;
	id_gt?: string | null;
	id_lt?: string | null;
	...
	recipient_contains?: string | null;
	recipient_not_contains?: string | null;
	dealTokenAmount?: WeiSource | null;
	dealTokenAmount_not?: WeiSource | null;
	dealTokenAmount_gt?: WeiSource | null;
	dealTokenAmount_lt?: WeiSource | null;
	dealTokenAmount_gte?: WeiSource | null;
	dealTokenAmount_lte?: WeiSource | null;
	dealTokenAmount_in?: WeiSource[];
	dealTokenAmount_not_in?: WeiSource[];
};
export type MintDealTokensResult = {
	id: string;
	dealContract: string;
	recipient: string;
	dealTokenAmount: Wei;
};
export type MintDealTokensFields = {
	id: true;
	dealContract: true;
	recipient: true;
	dealTokenAmount: true;
};
export type MintDealTokensArgs<K extends keyof MintDealTokensResult> = {
	[Property in keyof Pick<MintDealTokensFields, K>]: MintDealTokensFields[Property];
};
export const useGetMintDealTokensById = <K extends keyof MintDealTokensResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: MintDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<MintDealTokensResult, K>> = {}
) => {
	const func = async function <K extends keyof MintDealTokensResult>(
		url: string,
		options: SingleQueryOptions,
		args: MintDealTokensArgs<K>
	): Promise<Pick<MintDealTokensResult, K>> {
		const res = await axios.post(url, {
			query: generateGql('mintDealTokens', options, args),
		});
		const r = res.data as any;
		if (r.errors && r.errors.length) {
			throw new Error(r.errors[0].message);
		...
		if (obj['dealContract']) formattedObj['dealContract'] = obj['dealContract'];
		if (obj['recipient']) formattedObj['recipient'] = obj['recipient'];
		if (obj['dealTokenAmount']) formattedObj['dealTokenAmount'] = wei(obj['dealTokenAmount'], 0);
		return formattedObj as Pick<MintDealTokensResult, K>;
	};
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('MintDealTokens', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetMintDealTokenss = <K extends keyof MintDealTokensResult>(
	url: string,
	options?: MultiQueryOptions<MintDealTokensFilter, MintDealTokensResult>,
	args?: MintDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<MintDealTokensResult, K>[]> = {}
) => {
	const func = async function <K extends keyof MintDealTokensResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<MintDealTokensFilter, MintDealTokensResult>> =
			{ ...options };
		let paginationKey: keyof MintDealTokensFilter | null = null;
		let paginationValue = '';
		if (options.first && options.first > MAX_PAGE) {
			paginatedOptions.first = MAX_PAGE;
			paginatedOptions.orderBy = options.orderBy || 'id';
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof MintDealTokensFilter;
			paginatedOptions.where = { ...options.where };
		}
		let results: Pick<MintDealTokensResult, K>[] = [];
		do {
			if (paginationKey && paginationValue)
				paginatedOptions.where![paginationKey] = paginationValue as any;
			const res = await axios.post(url, {
				query: generateGql('mintDealTokenss', paginatedOptions, args),
			});
			const r = res.data as any;
			if (r.errors && r.errors.length) {
				throw new Error(r.errors[0].message);
			...
			const newResults = rawResults.map((obj) => {
				...
				if (obj['dealContract']) formattedObj['dealContract'] = obj['dealContract'];
				if (obj['recipient']) formattedObj['recipient'] = obj['recipient'];
				if (obj['dealTokenAmount'])
					formattedObj['dealTokenAmount'] = wei(obj['dealTokenAmount'], 0);
				return formattedObj as Pick<MintDealTokensResult, K>;
			});
			results = results.concat(newResults);
			if (newResults.length < 1000) {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('MintDealTokenss', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetPoolCreatedById = <K extends keyof PoolCreatedResult>(
	url: string,
	options?: SingleQueryOptions,
	...
	const func = async function <K extends keyof PoolCreatedResult>(
		...
		options: SingleQueryOptions,
		args: PoolCreatedArgs<K>
	): Promise<Pick<PoolCreatedResult, K>> {
		const res = await axios.post(url, {
...
export const useGetPoolCreateds = <K extends keyof PoolCreatedResult>(
	url: string,
	...
	const func = async function <K extends keyof PoolCreatedResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<PoolCreatedFilter, PoolCreatedResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof PoolCreatedFilter;
			paginatedOptions.where = { ...options.where };
		}
...
export const useGetPurchasePoolTokenById = <K extends keyof PurchasePoolTokenResult>(
	url: string,
	options?: SingleQueryOptions,
	...
	const func = async function <K extends keyof PurchasePoolTokenResult>(
		...
		options: SingleQueryOptions,
		args: PurchasePoolTokenArgs<K>
	): Promise<Pick<PurchasePoolTokenResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('PurchasePoolToken', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetPurchasePoolTokens = <K extends keyof PurchasePoolTokenResult>(
	url: string,
	...
	const func = async function <K extends keyof PurchasePoolTokenResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<PurchasePoolTokenFilter, PurchasePoolTokenResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof PurchasePoolTokenFilter;
			paginatedOptions.where = { ...options.where };
		}
...
export const useGetSetHolderById = <K extends keyof SetHolderResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: SetHolderArgs<K>,
	queryOptions: UseQueryOptions<Pick<SetHolderResult, K>> = {}
) => {
	const func = async function <K extends keyof SetHolderResult>(
		url: string,
		options: SingleQueryOptions,
		args: SetHolderArgs<K>
	): Promise<Pick<SetHolderResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('SetHolder', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetSetHolders = <K extends keyof SetHolderResult>(
	url: string,
	options?: MultiQueryOptions<SetHolderFilter, SetHolderResult>,
	args?: SetHolderArgs<K>,
	queryOptions: UseQueryOptions<Pick<SetHolderResult, K>[]> = {}
) => {
	const func = async function <K extends keyof SetHolderResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<SetHolderFilter, SetHolderResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof SetHolderFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('SetHolders', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetSetSponsorById = <K extends keyof SetSponsorResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: SetSponsorArgs<K>,
	queryOptions: UseQueryOptions<Pick<SetSponsorResult, K>> = {}
) => {
	const func = async function <K extends keyof SetSponsorResult>(
		url: string,
		options: SingleQueryOptions,
		args: SetSponsorArgs<K>
	): Promise<Pick<SetSponsorResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('SetSponsor', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetSetSponsors = <K extends keyof SetSponsorResult>(
	url: string,
	options?: MultiQueryOptions<SetSponsorFilter, SetSponsorResult>,
	args?: SetSponsorArgs<K>,
	queryOptions: UseQueryOptions<Pick<SetSponsorResult, K>[]> = {}
) => {
	const func = async function <K extends keyof SetSponsorResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<SetSponsorFilter, SetSponsorResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof SetSponsorFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('SetSponsors', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetTransferById = <K extends keyof TransferResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: TransferArgs<K>,
	queryOptions: UseQueryOptions<Pick<TransferResult, K>> = {}
) => {
	const func = async function <K extends keyof TransferResult>(
		url: string,
		options: SingleQueryOptions,
		args: TransferArgs<K>
	): Promise<Pick<TransferResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('Transfer', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetTransfers = <K extends keyof TransferResult>(
	url: string,
	options?: MultiQueryOptions<TransferFilter, TransferResult>,
	args?: TransferArgs<K>,
	queryOptions: UseQueryOptions<Pick<TransferResult, K>[]> = {}
) => {
	const func = async function <K extends keyof TransferResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<TransferFilter, TransferResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof TransferFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('Transfers', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetWithdrawFromPoolById = <K extends keyof WithdrawFromPoolResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: WithdrawFromPoolArgs<K>,
	queryOptions: UseQueryOptions<Pick<WithdrawFromPoolResult, K>> = {}
) => {
	const func = async function <K extends keyof WithdrawFromPoolResult>(
		url: string,
		options: SingleQueryOptions,
		args: WithdrawFromPoolArgs<K>
	): Promise<Pick<WithdrawFromPoolResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('WithdrawFromPool', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetWithdrawFromPools = <K extends keyof WithdrawFromPoolResult>(
	url: string,
	options?: MultiQueryOptions<WithdrawFromPoolFilter, WithdrawFromPoolResult>,
	args?: WithdrawFromPoolArgs<K>,
	queryOptions: UseQueryOptions<Pick<WithdrawFromPoolResult, K>[]> = {}
) => {
	const func = async function <K extends keyof WithdrawFromPoolResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<WithdrawFromPoolFilter, WithdrawFromPoolResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof WithdrawFromPoolFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('WithdrawFromPools', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export type WithdrawUnderlyingDealTokensArgs<K extends keyof WithdrawUnderlyingDealTokensResult> = {
	[Property in keyof Pick<
		WithdrawUnderlyingDealTokensFields,
		K
	>]: WithdrawUnderlyingDealTokensFields[Property];
};
export const useGetWithdrawUnderlyingDealTokensById = <
	K extends keyof WithdrawUnderlyingDealTokensResult
>(
	url: string,
	options?: SingleQueryOptions,
	args?: WithdrawUnderlyingDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<WithdrawUnderlyingDealTokensResult, K>> = {}
) => {
	const func = async function <K extends keyof WithdrawUnderlyingDealTokensResult>(
		url: string,
		options: SingleQueryOptions,
		args: WithdrawUnderlyingDealTokensArgs<K>
	): Promise<Pick<WithdrawUnderlyingDealTokensResult, K>> {
		const res = await axios.post(url, {
	...
	return useQuery(
		[
			'codegen-graphql',
			enabled ? generateGql('WithdrawUnderlyingDealTokens', options, args) : null,
		],
		async () => func(url, options!, args!),
		{
			...queryOptions,
...
export const useGetWithdrawUnderlyingDealTokenss = <
	K extends keyof WithdrawUnderlyingDealTokensResult
>(
	url: string,
	options?: MultiQueryOptions<
		WithdrawUnderlyingDealTokensFilter,
		WithdrawUnderlyingDealTokensResult
	>,
	args?: WithdrawUnderlyingDealTokensArgs<K>,
	queryOptions: UseQueryOptions<Pick<WithdrawUnderlyingDealTokensResult, K>[]> = {}
) => {
	const func = async function <K extends keyof WithdrawUnderlyingDealTokensResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<WithdrawUnderlyingDealTokensFilter, WithdrawUnderlyingDealTokensResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof WithdrawUnderlyingDealTokensFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	return useQuery(
		[
			'codegen-graphql',
			enabled ? generateGql('WithdrawUnderlyingDealTokenss', options, args) : null,
		],
		async () => func(url, options!, args!),
		{
			...queryOptions,
