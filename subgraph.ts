...
export const useGetAelinTokenById = <K extends keyof AelinTokenResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: AelinTokenArgs<K>,
	queryOptions: UseQueryOptions<Pick<AelinTokenResult, K>> = {}
) => {
	const func = async function <K extends keyof AelinTokenResult>(
		url: string,
		options: SingleQueryOptions,
		args: AelinTokenArgs<K>
	): Promise<Pick<AelinTokenResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('AelinToken', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetAelinTokens = <K extends keyof AelinTokenResult>(
	url: string,
	options?: MultiQueryOptions<AelinTokenFilter, AelinTokenResult>,
	args?: AelinTokenArgs<K>,
	queryOptions: UseQueryOptions<Pick<AelinTokenResult, K>[]> = {}
) => {
	const func = async function <K extends keyof AelinTokenResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<AelinTokenFilter, AelinTokenResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof AelinTokenFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('AelinTokens', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export type ClaimedUnderlyingDealTokenArgs<K extends keyof ClaimedUnderlyingDealTokenResult> = {
	[Property in keyof Pick<
		ClaimedUnderlyingDealTokenFields,
		K
	>]: ClaimedUnderlyingDealTokenFields[Property];
};
export const useGetClaimedUnderlyingDealTokenById = <
	K extends keyof ClaimedUnderlyingDealTokenResult
>(
	url: string,
	options?: SingleQueryOptions,
	...
	const func = async function <K extends keyof ClaimedUnderlyingDealTokenResult>(
		...
		options: SingleQueryOptions,
		args: ClaimedUnderlyingDealTokenArgs<K>
	): Promise<Pick<ClaimedUnderlyingDealTokenResult, K>> {
		const res = await axios.post(url, {
...
export const useGetClaimedUnderlyingDealTokens = <K extends keyof ClaimedUnderlyingDealTokenResult>(
	url: string,
	...
	const func = async function <K extends keyof ClaimedUnderlyingDealTokenResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<ClaimedUnderlyingDealTokenFilter, ClaimedUnderlyingDealTokenResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof ClaimedUnderlyingDealTokenFilter;
			paginatedOptions.where = { ...options.where };
		}
...
export const useGetDealDetailById = <K extends keyof DealDetailResult>(
	url: string,
	options?: SingleQueryOptions,
	...
	const func = async function <K extends keyof DealDetailResult>(
		...
		options: SingleQueryOptions,
		args: DealDetailArgs<K>
	): Promise<Pick<DealDetailResult, K>> {
		const res = await axios.post(url, {
...
export const useGetDealDetails = <K extends keyof DealDetailResult>(
	url: string,
	options?: MultiQueryOptions<DealDetailFilter, DealDetailResult>,
	args?: DealDetailArgs<K>,
	queryOptions: UseQueryOptions<Pick<DealDetailResult, K>[]> = {}
) => {
	const func = async function <K extends keyof DealDetailResult>(
		...
		const paginatedOptions: Partial<MultiQueryOptions<DealDetailFilter, DealDetailResult>> = {
			...options,
		};
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginatedOptions.orderDirection = options.orderDirection || 'asc';
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc' ? '_gt' : '_lt')) as keyof DealDetailFilter;
			paginatedOptions.where = { ...options.where };
		}
...
export const useGetDepositDealTokenById = <K extends keyof DepositDealTokenResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: DepositDealTokenArgs<K>,
	queryOptions: UseQueryOptions<Pick<DepositDealTokenResult, K>> = {}
) => {
	const func = async function <K extends keyof DepositDealTokenResult>(
		url: string,
		options: SingleQueryOptions,
		args: DepositDealTokenArgs<K>
	): Promise<Pick<DepositDealTokenResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('DepositDealToken', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetDepositDealTokens = <K extends keyof DepositDealTokenResult>(
	url: string,
	options?: MultiQueryOptions<DepositDealTokenFilter, DepositDealTokenResult>,
	args?: DepositDealTokenArgs<K>,
	queryOptions: UseQueryOptions<Pick<DepositDealTokenResult, K>[]> = {}
) => {
	const func = async function <K extends keyof DepositDealTokenResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<DepositDealTokenFilter, DepositDealTokenResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof DepositDealTokenFilter;
			paginatedOptions.where = { ...options.where };
		}
...
export const useGetTotalPoolsCreatedById = <K extends keyof TotalPoolsCreatedResult>(
	url: string,
	options?: SingleQueryOptions,
	args?: TotalPoolsCreatedArgs<K>,
	queryOptions: UseQueryOptions<Pick<TotalPoolsCreatedResult, K>> = {}
) => {
	const func = async function <K extends keyof TotalPoolsCreatedResult>(
		url: string,
		options: SingleQueryOptions,
		args: TotalPoolsCreatedArgs<K>
	): Promise<Pick<TotalPoolsCreatedResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('TotalPoolsCreated', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export const useGetTotalPoolsCreateds = <K extends keyof TotalPoolsCreatedResult>(
	url: string,
	options?: MultiQueryOptions<TotalPoolsCreatedFilter, TotalPoolsCreatedResult>,
	args?: TotalPoolsCreatedArgs<K>,
	queryOptions: UseQueryOptions<Pick<TotalPoolsCreatedResult, K>[]> = {}
) => {
	const func = async function <K extends keyof TotalPoolsCreatedResult>(
		...
		const paginatedOptions: Partial<
			MultiQueryOptions<TotalPoolsCreatedFilter, TotalPoolsCreatedResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof TotalPoolsCreatedFilter;
			paginatedOptions.where = { ...options.where };
		}
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('TotalPoolsCreateds', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
export type WithdrawUnderlyingDealTokenArgs<K extends keyof WithdrawUnderlyingDealTokenResult> = {
	[Property in keyof Pick<
		WithdrawUnderlyingDealTokenFields,
		K
	>]: WithdrawUnderlyingDealTokenFields[Property];
};
export const useGetWithdrawUnderlyingDealTokenById = <
	K extends keyof WithdrawUnderlyingDealTokenResult
>(
	url: string,
	options?: SingleQueryOptions,
	args?: WithdrawUnderlyingDealTokenArgs<K>,
	queryOptions: UseQueryOptions<Pick<WithdrawUnderlyingDealTokenResult, K>> = {}
) => {
	const func = async function <K extends keyof WithdrawUnderlyingDealTokenResult>(
		url: string,
		options: SingleQueryOptions,
		args: WithdrawUnderlyingDealTokenArgs<K>
	): Promise<Pick<WithdrawUnderlyingDealTokenResult, K>> {
		const res = await axios.post(url, {
	...
	const enabled = options && args;
	return useQuery(
		['codegen-graphql', enabled ? generateGql('WithdrawUnderlyingDealToken', options, args) : null],
		async () => func(url, options!, args!),
		{
			...queryOptions,
			enabled: !!options && !!args,
...
>(
	url: string,
	options?: MultiQueryOptions<WithdrawUnderlyingDealTokenFilter, WithdrawUnderlyingDealTokenResult>,
	args?: WithdrawUnderlyingDealTokenArgs<K>,
	queryOptions: UseQueryOptions<Pick<WithdrawUnderlyingDealTokenResult, K>[]> = {}
) => {
	const func = async function <K extends keyof WithdrawUnderlyingDealTokenResult>(
		...
		options: MultiQueryOptions<
			WithdrawUnderlyingDealTokenFilter,
			WithdrawUnderlyingDealTokenResult
		>,
		args: WithdrawUnderlyingDealTokenArgs<K>
	): Promise<Pick<WithdrawUnderlyingDealTokenResult, K>[]> {
		const paginatedOptions: Partial<
			MultiQueryOptions<WithdrawUnderlyingDealTokenFilter, WithdrawUnderlyingDealTokenResult>
		> = { ...options };
		...
		if (options.first && options.first > MAX_PAGE) {
			...
			paginationKey = (paginatedOptions.orderBy +
				(paginatedOptions.orderDirection === 'asc'
					? '_gt'
					: '_lt')) as keyof WithdrawUnderlyingDealTokenFilter;
			paginatedOptions.where = { ...options.where };
		}
