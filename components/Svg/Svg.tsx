...
export const MenuClose = ({ className }: SvgProps) => (
...
export const DownArrow = ({ className }: SvgProps) => (
	<Icon viewBox="0 0 14 14" className={className}>
		<path d="M6 9L0.803847 -2.51245e-08L11.1962 8.834e-07L6 9Z" />
	</Icon>
);

export const SortArrows = ({ className }: SvgProps) => (
	<Icon viewBox="0 0 9 16" className={className}>
		<path id="up" d="M4.19922 0L7.66332 6L0.735117 6L4.19922 0Z" />
		<path id="down" d="M4.19922 16L0.735117 10L7.66332 10L4.19922 16Z" />
	</Icon>
);

export const MeatBall = ({ className }: SvgProps) => (
...
export const LeftEndArrow = ({ className }: SvgProps) => (
...
export const RightEndArrow = ({ className }: SvgProps) => (
	<Icon viewBox="0 0 16 16" className={className}>
...
export const EtherscanLinkIcon = ({ className }: SvgProps) => (
	<Icon viewBox="0 0 16 16" className={className}>
